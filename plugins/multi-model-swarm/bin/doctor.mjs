...
const envForkVersion = process.env.KIMI_CODE_SWARM_VERSION?.trim();
const forkVersion = envForkVersion === undefined || envForkVersion.length === 0 ? 'missing' : envForkVersion;
